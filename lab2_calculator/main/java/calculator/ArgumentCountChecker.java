...
public class ArgumentCountChecker {
    ...
    public void checkNumberOfArguments(int numberOfArguments, int correctNumberOfArguments, String className) throws IncorrectNumberOfArgumentsException {
    ...
    public void checkNumberOfValues(int numberValues, int numberOfRequiredValues, String className) throws NotEnoughDataInStackException {
